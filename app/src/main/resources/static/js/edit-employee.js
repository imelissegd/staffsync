...
async function loadEmployee() {
    ...
    try {
        ...
        // Update subtitle
        document.getElementById('pageSubtitle').textContent = `Editing: ${employee.name}`;
...
async function handleSubmit(e) {
    ...
    try {
        ...
        showMessage(error.message || 'Failed to update employee. Please try again.', 'error');
...
function validateForm() {
    ...
    // Employee ID (readonly, but still validate)
